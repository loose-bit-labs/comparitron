...
function run(runId) {
  ...
  const defaultHw = config.hardware?.tag || 'unknown'
  const date = resolvedRunId ? resolvedRunId.slice(0, 10) : new Date().toISOString().slice(0, 10)
